...
import '../activity_check_candi_screen/activity_check_candi_screen.dart';
import '../menu_screen/menu_screen.dart';
import '../home_screen/home_screen.dart';
class GotoResultScreen extends StatefulWidget {
  final connector,session, uri,flag;
  var votefor;
  GotoResultScreen({Key? key,
  ...
  State<GotoResultScreen> createState() =>
      _GotoResultScreenState();
}

class _GotoResultScreenState extends State<GotoResultScreen>{

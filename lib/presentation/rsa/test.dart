...
class TESTEncoding extends BaseAsymmetricBlockCipher {
  ...
  static final FactoryConfig factoryConfig = DynamicFactoryConfig.suffix(
      ...
      (_, final Match match) => () {
            ...
            return TESTEncoding(underlyingCipher);
          });
  ...
  TESTEncoding(this._engine);

  @override
  String get algorithmName => '${_engine.algorithmName}/TEST';
